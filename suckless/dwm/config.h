...
/* tagging */
static const char *tags[] = { "web", "code", "db", "mes", "etc", "games" };
...
static Key keys[] = {
    ...
    { 0,                XF86XK_AudioLowerVolume,       spawn,          {.v = adec } },
    { 0,                XF86XK_AudioRaiseVolume,       spawn,          {.v = ainc } },
    { 0,                XF86XK_AudioMute,              spawn,          {.v = atoggle } },
